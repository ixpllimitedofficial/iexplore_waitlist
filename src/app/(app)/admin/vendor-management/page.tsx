...
const page = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-5 p-">
        <div className={divStyle}>
          ...
          <span className="bg-[#008800] border border-[#b4ddb4]  p-2 rounded-full text-white  font-semibold whitespace-nowrap">+16% from last week</span>
        </div>

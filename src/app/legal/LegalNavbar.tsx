...
const LegalNavbar = ({ active }: LegalNavbarProps) => {
  ...
  return (
    <>
      {/* Header with Search */}
      <header className="fixed top-0 left-0 right-0 bg-brandDarkNeutral border-b border-gold-500/20 z-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              <Link href="/" className="flex items-center space-x-2 hover:opacity-80 transition-opacity">
                ...
                <span className="text-gold-500 font-semibold">iExplore</span>
              </Link>
      ...
      {isMobileMenuOpen && (
        <div className="fixed top-[120px] left-0 right-0 bg-brandDarkNeutral border-b border-gold-500/20 z-40 md:hidden max-h-[calc(100vh-120px)] overflow-y-auto">
      ...
      {/* Desktop Sidebar */}
      <aside className="hidden md:block fixed left-0 top-[72px] w-[240px] h-[calc(100vh-72px)] bg-brandDarkNeutral border-r border-gold-500/20 z-30 overflow-y-auto">
        <div className="p-4">

...
const ClubCard = () => {
  ...
  const handleClick = () => {
    router.push("/vendor-Home/business/1");
  };
      ...
      <div className="flex md:block">
        ...
        <div className="">
          <div className="flex items-center justify-between mt-4 mb-1 px-2">
            <h1 className=" text-lg md:text-xl font-bold">Maxx BBQs & Bistro</h1>
          ...
          <p className="pl-2 text-sm md:text-lg text-[#D1D1D1]">Tejuosho Mall, Yaba</p>

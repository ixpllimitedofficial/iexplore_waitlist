...
const ForgotPassword = () => {
  ...
  return (
    <section className="h-full flex flex-col gap-2 pt-16 lg:pt-28">
      <h1 className="text-gold-500 font-semibold text-2xl md:text-3xl text-center leading-snug self-center hidden lg:block">
        Forgot Password?
      </h1>
      ...
      <Form {...form}>
        ...
        >
          ...
          <NewAppButton btnText="Send code" type="submit" className="text-sm" />
        </form>
      </Form>

      <div className="flex items-center justify-center gap-1 text-sm">
        <p className="text-[##FBE9D0] text-center">Remember password?</p>
        <Link href="/vendor-Home" className="text-gold-500 underline font-semibold">
          {" "}
          Login
        </Link>
      </div>

...
const Category = () => {
  return (
    <section className="bg-brandDarkNeutral border-2 border-gold-500 rounded-xl p-3 md:p-5 flex flex-wrap gap-3 md:justify-between w-[80%] lg:w-[55vw] mx-auto mt-5">

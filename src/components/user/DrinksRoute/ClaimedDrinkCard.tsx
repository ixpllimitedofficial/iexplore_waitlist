...
const ClaimedDrinkCard = () => {
  ...
  return (
    <div
      className="relative bg-[#0E0E0E] border-2 border-gold-500 px-2 py-3 rounded-3xl flex flex-col"
    >
      {/* badge */}
      ...
      <div className="px-2 flex items-center my-1">
        <p className="text-xl font-bold text-[#D1D1D1]">N232,000</p>
        <p className="pl-2 text-[#D1D1D1]">
          Claimed at Club Quilox - 2/11/2024
        </p>
      </div>
...
export default ClaimedDrinkCard;

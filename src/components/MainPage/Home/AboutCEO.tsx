...
import AboutCEOimg2 from "@/assets/img/MainWebsite/AboutCEOimg2.png";
  ...
  return (
    <section className="bg-[#F2F1E8] px-14 py-20 grid grid-cols-2 gap-10">
      ...
      <div>
        ...
        <p className="text-[#0E1111] leading-loose text-xl font-medium w-[80%] mx-auto mt-5">
          Our app revolutionizes the nightlife experience in Africa, born from a
          passion to connect explorers with the best spots in their city. We’re
          not just an app; we’re your gateway to deeper connections and
        ...
        <h3
          className={`text-[#0E1111] text-3xl w-[80%] mx-auto mt-3 ${anton.className} `}
        >
          MD/CEO IEXPLORE
        </h3>
        <Image

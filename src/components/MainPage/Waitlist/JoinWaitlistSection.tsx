...
const JoinWaitlistSection = () => {
  return (
    <>
      <section className="mt-24 flex flex-col items-center text-center gap-3 px-4 md:w-3/5 mx-auto">
      ...
      <div className="mt-10 mb-24 flex flex-col md:flex-row items-center gap-4 px-4 md:w-3/5 mx-auto">
        <Input

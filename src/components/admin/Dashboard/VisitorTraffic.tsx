...
const VisitorTraffic = () => {
    return (
        <Card className="bg-[#23232325] border-none flex flex-row lg:flex-nowrap items-center justify-between gap-4">
            <div className="w-[50%] lg:w-[30%] flex flex-col items-center text-center md:space-y-2 mt- md:mt-4">
                <h1 className="text-3xl lg:text-4xl font-bold text-white">201</h1>

                <p className=" mt-5 text-muted-foreground text-xs lg:text-sm">New Vendor</p>

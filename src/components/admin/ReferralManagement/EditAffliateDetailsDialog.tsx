  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="w-full md:w-[70%] px-6 py-2 bg-[#232323] rounded-2xl border border-[#4D4D4D] text-white text-sm font-medium hover:shadow-lg transition-shadow duration-300">
          <p>Edit</p>
        </Button>
      </DialogTrigger>

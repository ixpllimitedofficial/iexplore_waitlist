...
const BlogsAndUpdates = () => {
  return (
    <section className="px-5 pt-10 md:pt-14">
      <div className="flex flex-col lg:flex-row items-center justify-between text-center lg:text-left gap-3">
        {/* <h3
        ...
        <h3
          className={`text-[#F2F1E8] text-4xl lg:text-6xl mt-3 md:mt-0 ${anton.className} `}
        >
          BLOG & UPDATES
        </h3>
        <p className="text-[#D1D1D1] lg:text-lg lg:w-[50%]">
      ...
      <div className="mt-8 md:mt-14 grid grid-cols-6 gap-10">
        {[1, 2, 3].map((item) => {
          return (
            <div
              key={item}

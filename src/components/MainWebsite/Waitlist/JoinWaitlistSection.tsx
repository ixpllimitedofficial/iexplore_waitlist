...
const JoinWaitlistSection = () => {
  return (
    <>
      <section className="mt-10 flex flex-col items-center text-center gap-2 px-4 md:w-[65%] lg:w-2/4 mx-auto">
      ...
      <div className="mt-5 mb-16 flex flex-col lg:flex-row items-center gap-4 px-4 md:w-3/5 mx-auto">
        <Input
        ...
        />
        <Button className="bg-gold-500 transition duration-200 hover:bg-white text-[#322016] px-7 py-5 md:px-10 md:py-6 rounded-3xl font-bold text-base">
          Get early access
        </Button>
      </div>
    </>

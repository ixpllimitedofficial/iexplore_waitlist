...
const AboutSection = () => {
  return (
    <>
      <section className="mb-8 flex flex-col items-center text-center gap-3 px-4 md:w-[65%] lg:w-2/4 mx-auto">
        ...
        <h1 className={`text-gold-500 text-4xl md:text-5xl lg:text-6xl ${anton.className}`}>

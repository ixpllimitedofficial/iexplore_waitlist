...
const ProfileCard = () => {
  return (
    <Link
      ...
      className="hidden lg:flex items-center gap-3 bg-[#F7D0984D] p-4 rounded-2xl"
    >
      <Avatar>
      ...
      <div>
        <p className="text-[#F7D098] font-bold text-sm">Anita Cruz</p>
        <p className="text-[#F7D098] text-sm">anita@commerce.com</p>
      </div>

...
const HeroSection = () => {
  return (
    <section
      ...
      className="relative flex items-center justify-center h-[250px] md:h-[400px] lg:h-[600px] w-[90vw] md:w-[85vw] mx-auto mb-10 rounded-3xl bg-no-repeat bg-cover bg-center "
    >
      <div className="absolute w-[70%] bottom-5 md:bottom-10 lg:bottom-16 flex flex-col justify-center items-center">
        <h1 className="font-bold text-3xl md:text-5xl lg:text-7xl text-center">
